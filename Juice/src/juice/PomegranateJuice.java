 ...
 * @author Aman Pathak
 */
public class PomegranateJuice extends javax.swing.JFrame {

    /**
     * Creates new form PomegranateJuice
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/juice/icons/Pome317.png"))); // NOI18N
        ...
        jLabel19.setText("POMEGRANATE JUICE");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(flag==1) {
        this.dispose();
        PomegranateGlass PGlass=new PomegranateGlass();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PomegranateJuice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PomegranateJuice().setVisible(true);
            }
        });
    }
