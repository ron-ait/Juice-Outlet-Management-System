 ...
 * @author Aman Pathak
 */
public class PomegranateGlass extends javax.swing.JFrame {

    /**
     * Creates new form PomegranateGlass
     */
    public PomegranateGlass() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.dispose();
        PomegranateJuice A=new PomegranateJuice();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String juicename="Pomegranate Juice";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PomegranateGlass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PomegranateGlass().setVisible(true);
            }
        });
    }
