 ...
 * @author Aman Pathak
 */
public class CarrotJuice extends javax.swing.JFrame {

    /**
     * Creates new form CarrotJuice
     */
    public CarrotJuice() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/juice/icons/Carrot317.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(flag==1) {
        this.dispose();
        CarrotGlass CGlass=new CarrotGlass();
        CGlass.setVisible(true);  
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarrotJuice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CarrotJuice().setVisible(true);
            }
        });
    }
