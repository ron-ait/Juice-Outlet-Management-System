 ...
 * @author Aman Pathak
 */
public class MangoGlass extends javax.swing.JFrame {

    /**
     * Creates new form MangoGlass
     */
    public MangoGlass() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(408, 393));
        setResizable(false);
    ...
    public void reset() {
        ...
        no_of_glasses.setSelectedIndex(0);
    }
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       reset(); // issue coming this and below lines
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MangoGlass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new MangoGlass().setVisible(true);
            }
        });
    }
