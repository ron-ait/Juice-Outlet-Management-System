 ...
 * @author Aman Pathak
 */
public class MangoJuice extends javax.swing.JFrame {

    /**
     * Creates new form MangoJuice
     */
    public MangoJuice() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/juice/icons/Mango317.png"))); // NOI18N
        ...
        jLabel17.setText("DESIGNED BY: AMAN PATHAK");
        jLabel17.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(255, 51, 51));
        jLabel18.setText("MANGO JUICE");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(flag==1) {
        this.dispose();
        MangoGlass MGlass=new MangoGlass();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MangoJuice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MangoJuice().setVisible(true);
            }
        });
    }
