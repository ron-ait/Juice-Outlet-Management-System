 ...
 * @author Aman Pathak
 */
public class BananaGlass extends javax.swing.JFrame {

    /**
     * Creates new form BananaGlass
     */
    public BananaGlass() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BananaGlass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BananaGlass().setVisible(true);
            }
        });
    }
